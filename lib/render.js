...
<main class="wrap">
  <section id="fuel" style="border-bottom:none;">
    ...
    <p>Not academic, but you asked. The closest McDonald's and Domino's to each campus, with directions. Distances are approximate and chains open and close — tap through to confirm before you make the trip.</p>
    <div class="cards">
    ${order
      .map((slug) => {
        const s = schools[slug];
