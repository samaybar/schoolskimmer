...
${compareCards}
    ...
    <p>The cleanest way to tell them apart is academic philosophy and culture. <strong>Williams</strong> gives you the most structure — distribution requirements across divisions, its Oxford-style tutorials, and a January Winter Study term. <strong>Amherst</strong> gives you a pure open curriculum at a small, self-contained college, plus access to four neighboring schools. <strong>Wesleyan</strong> also has an open curriculum, but at a noticeably larger university with a distinctive arts, film, and social-engagement culture.</p>
    <p>On the practical axes they're close: all three are NESCAC Division III, all meet full demonstrated financial need, all are test-optional. The clearest splits are selectivity and size — Williams and Amherst admit well under 10% and enroll around 2,000, while Wesleyan admits around 16% and enrolls roughly 3,000. Setting differs too: Williams in the mountains, Amherst in a college-town valley, Wesleyan in a small Connecticut city. If you're choosing among them, fit and culture will likely matter more than any single number.</p>
  </section>
</main>
`;
  html += disclaimer();
